...
//	@Test
	public void selectPW() { //아이디와 이름으로 비번찾기
		AdminVo vo = new AdminVo("Goobee", null , "꽈자와자", null , null);
		List<AdminVo> one = dao.selectPW(vo);
...
//	@Test // 이름과 휴대폰번호로 아이디 찾기
	public void selectID() {
		...
		List<AdminVo> one = dao.selectID(vo);
		System.out.println(one.get(0));
		assertEquals("결과값 있음", one.size(), 1);
	}
...
//	@Test
	public void selectCEO() { // 대표자명으로 조회 - 한슬기
		String str = "완벽한남자김휘웅";
		Object obj = str;
...
//	@Test
	public void selectAcCode() { // 거래처코드로 조회 - 한슬기
		String str = "3";
		Object obj = str;
...
//		@Test
		...
		// 김휘웅 재고 입력 (상품코드 상품명 수량 제조일자 유통기한) 상품코드, 상품명 : FK이기때문에 GOODS에서 조회후 넣으면 된다
//		@Test
		public void insertInventory01() {
			IInsertDao dao = new InsertDaoImpl();
			InventoryVo vo = new InventoryVo("ABC1234570", "바밤바", 50,"2022-02-10");
